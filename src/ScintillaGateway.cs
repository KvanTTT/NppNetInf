...
namespace NppNetInf
{
    ...
    public class ScintillaGateway : IScintillaGateway
    {
        ...
        {
            scintilla = scintilla == PluginBase.NppData._scintillaMainHandle ? PluginBase.NppData._scintillaSecondHandle : PluginBase.NppData._scintillaMainHandle;
        }
        ...
        {
            var selectionLength = (int) SendMessage(scintilla, SciMsg.SCI_GETSELTEXT, Unused, Unused) - LengthZeroTerminator;
        ...
        public unsafe void AddText(int length, string text)
        {
            ...
            {
                SendMessage(scintilla, SciMsg.SCI_ADDTEXT, length, (IntPtr) textPtr);
            }
        }
        ...
        public unsafe void AddStyledText(int length, Cells c)
        {
            ...
            {
                SendMessage(scintilla, SciMsg.SCI_ADDSTYLEDTEXT, length, (IntPtr) cPtr);
            }
        }
        ...
        public unsafe void InsertText(Position pos, string text)
        {
            fixed (byte* textPtr = Encoding.UTF8.GetBytes(text))
            {
                SendMessage(scintilla, SciMsg.SCI_INSERTTEXT, pos.Value, (IntPtr) textPtr);
            }
        }
        ...
        public unsafe void ChangeInsertion(int length, string text)
        {
            fixed (byte* textPtr = Encoding.UTF8.GetBytes(text))
            {
                SendMessage(scintilla, SciMsg.SCI_CHANGEINSERTION, length, (IntPtr) textPtr);
            }
        }
        ...
        {
            SendMessage(scintilla, SciMsg.SCI_CLEARALL, Unused, Unused);
        }
        ...
        {
            SendMessage(scintilla, SciMsg.SCI_DELETERANGE, pos.Value, deleteLength);
        }
        ...
        {
            SendMessage(scintilla, SciMsg.SCI_CLEARDOCUMENTSTYLE, Unused, Unused);
        }

        /// <summary>Returns the number of bytes in the document. (Scintilla feature 2006)</summary>
        public int GetLength()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETLENGTH, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCHARAT, pos.Value, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCURRENTPOS, Unused, Unused);
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETANCHOR, Unused, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSTYLEAT, pos.Value, Unused);
            return (int) res;
        }
        ...
        public void Redo()
        {
            SendMessage(scintilla, SciMsg.SCI_REDO, Unused, Unused);
        }
        ...
        {
            SendMessage(scintilla, SciMsg.SCI_SETUNDOCOLLECTION, collectUndo ? 1 : 0, Unused);
        }

        /// <summary>Select all the text in the document. (Scintilla feature 2013)</summary>
        public void SelectAll()
        {
            SendMessage(scintilla, SciMsg.SCI_SELECTALL, Unused, Unused);
        }
        ...
        {
            SendMessage(scintilla, SciMsg.SCI_SETSAVEPOINT, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSTYLEDTEXT, Unused, tr.NativePointer);
            return (int) res;
        }
        ...
        public bool CanRedo()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CANREDO, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERLINEFROMHANDLE, handle, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERDELETEHANDLE, handle, Unused);
        }

        /// <summary>Is undo history being collected? (Scintilla feature 2019)</summary>
        public bool GetUndoCollection()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETUNDOCOLLECTION, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETVIEWWS, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETVIEWWS, viewWS, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_POSITIONFROMPOINT, x, y);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_POSITIONFROMPOINTCLOSE, x, y);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GOTOLINE, line, Unused);
        }

        /// <summary>Set caret to a position and ensure it is visible. (Scintilla feature 2025)</summary>
        public void GotoPos(Position pos)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GOTOPOS, pos.Value, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETANCHOR, posAnchor.Value, Unused);
        }
        ...
        public unsafe string GetCurLine(int length)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCURLINE, length, (IntPtr) textPtr);
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETENDSTYLED, Unused, Unused);
            return new Position((int) res);
        }
        ...
        {
            SendMessage(scintilla, SciMsg.SCI_CONVERTEOLS, eolMode, Unused);
        }

        /// <summary>Retrieve the current end of line mode - one of CRLF, CR, or LF. (Scintilla feature 2030)</summary>
        public int GetEOLMode()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETEOLMODE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            SendMessage(scintilla, SciMsg.SCI_SETEOLMODE, eolMode, Unused);
        }
        ...
        {
            SendMessage(scintilla, SciMsg.SCI_STARTSTYLING, pos.Value, mask);
        }
        ...
        {
            SendMessage(scintilla, SciMsg.SCI_SETSTYLING, length, style);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETBUFFEREDDRAW, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETBUFFEREDDRAW, buffered ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETTABWIDTH, tabWidth, Unused);
        }

        /// <summary>Retrieve the visible size of a tab. (Scintilla feature 2121)</summary>
        public int GetTabWidth()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETTABWIDTH, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CLEARTABSTOPS, line, Unused);
        }

        /// <summary>Add an explicit tab stop for a line. (Scintilla feature 2676)</summary>
        public void AddTabStop(int line, int x)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ADDTABSTOP, line, x);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETNEXTTABSTOP, line, x);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETCODEPAGE, codePage, Unused);
        }

        /// <summary>Is the IME displayed in a winow or inline? (Scintilla feature 2678)</summary>
        public int GetIMEInteraction()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETIMEINTERACTION, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETIMEINTERACTION, imeInteraction, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERDEFINE, markerNumber, markerSymbol);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERSETFORE, markerNumber, fore.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERSETBACK, markerNumber, back.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERSETBACKSELECTED, markerNumber, back.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERENABLEHIGHLIGHT, enabled ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERADD, line, markerNumber);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERDELETE, line, markerNumber);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERDELETEALL, markerNumber, Unused);
        }

        /// <summary>Get a bit mask of all the markers set on a line. (Scintilla feature 2046)</summary>
        public int MarkerGet(int line)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERGET, line, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERNEXT, lineStart, markerMask);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERPREVIOUS, lineStart, markerMask);
            return (int) res;
        }
        ...
        public unsafe void MarkerDefinePixmap(int markerNumber, string pixmap)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERDEFINEPIXMAP, markerNumber, (IntPtr) pixmapPtr);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERADDSET, line, set);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERSETALPHA, markerNumber, alpha);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETMARGINTYPEN, margin, marginType);
        }

        /// <summary>Retrieve the type of a margin. (Scintilla feature 2241)</summary>
        public int GetMarginTypeN(int margin)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMARGINTYPEN, margin, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETMARGINWIDTHN, margin, pixelWidth);
        }

        /// <summary>Retrieve the width of a margin in pixels. (Scintilla feature 2243)</summary>
        public int GetMarginWidthN(int margin)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMARGINWIDTHN, margin, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETMARGINMASKN, margin, mask);
        }

        /// <summary>Retrieve the marker mask of a margin. (Scintilla feature 2245)</summary>
        public int GetMarginMaskN(int margin)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMARGINMASKN, margin, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETMARGINSENSITIVEN, margin, sensitive ? 1 : 0);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMARGINSENSITIVEN, margin, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETMARGINCURSORN, margin, cursor);
        }

        /// <summary>Retrieve the cursor shown in a margin. (Scintilla feature 2249)</summary>
        public int GetMarginCursorN(int margin)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMARGINCURSORN, margin, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLECLEARALL, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLESETFORE, style, fore.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLESETSIZE, style, sizePoints);
        }
        ...
        public unsafe void StyleSetFont(int style, string fontName)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLESETFONT, style, (IntPtr) fontNamePtr);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLESETEOLFILLED, style, filled ? 1 : 0);
        }

        /// <summary>Reset the default style to its state at startup (Scintilla feature 2058)</summary>
        public void StyleResetDefault()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLERESETDEFAULT, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLESETUNDERLINE, style, underline ? 1 : 0);
        }

        /// <summary>Get the foreground colour of a style. (Scintilla feature 2481)</summary>
        public Colour StyleGetFore(int style)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLEGETFORE, style, Unused);
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLEGETBACK, style, Unused);
            return new Colour((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLEGETBOLD, style, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLEGETITALIC, style, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLEGETSIZE, style, Unused);
            return (int) res;
        }
        ...
        public unsafe string StyleGetFont(int style)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLEGETFONT, style, (IntPtr) fontNamePtr);
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLEGETEOLFILLED, style, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLEGETUNDERLINE, style, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLEGETCASE, style, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLEGETCHARACTERSET, style, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLEGETVISIBLE, style, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLEGETCHANGEABLE, style, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLEGETHOTSPOT, style, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLESETCASE, style, caseForce);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLESETSIZEFRACTIONAL, style, caseForce);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLEGETSIZEFRACTIONAL, style, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLESETWEIGHT, style, weight);
        }

        /// <summary>Get the weight of characters of a style. (Scintilla feature 2064)</summary>
        public int StyleGetWeight(int style)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLEGETWEIGHT, style, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLESETCHARACTERSET, style, characterSet);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLESETHOTSPOT, style, hotspot ? 1 : 0);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSELFORE, useSetting ? 1 : 0, fore.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSELBACK, useSetting ? 1 : 0, back.Value);
        }

        /// <summary>Get the alpha of the selection. (Scintilla feature 2477)</summary>
        public int GetSelAlpha()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSELALPHA, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSELALPHA, alpha, Unused);
        }

        /// <summary>Is the selection end of line filled? (Scintilla feature 2479)</summary>
        public bool GetSelEOLFilled()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSELEOLFILLED, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSELEOLFILLED, filled ? 1 : 0, Unused);
        }

        /// <summary>Set the foreground colour of the caret. (Scintilla feature 2069)</summary>
        public void SetCaretFore(Colour fore)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETCARETFORE, fore.Value, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ASSIGNCMDKEY, km.Value, msg);
        }
        ...
        {
            SendMessage(scintilla, SciMsg.SCI_CLEARCMDKEY, km.Value, Unused);
        }

        /// <summary>Drop all key mappings. (Scintilla feature 2072)</summary>
        public void ClearAllCmdKeys()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CLEARALLCMDKEYS, Unused, Unused);
        }
        ...
        public unsafe void SetStylingEx(int length, string styles)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSTYLINGEX, length, (IntPtr) stylesPtr);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLESETVISIBLE, style, visible ? 1 : 0);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCARETPERIOD, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETCARETPERIOD, periodMilliseconds, Unused);
        }
        ...
        public unsafe void SetWordChars(string characters)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETWORDCHARS, Unused, (IntPtr) charactersPtr);
            }
        }
        ...
        public unsafe string GetWordChars()
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETWORDCHARS, Unused, (IntPtr) charactersPtr);
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_BEGINUNDOACTION, Unused, Unused);
        }

        /// <summary>End a sequence of actions that is undone and redone as a unit. (Scintilla feature 2079)</summary>
        public void EndUndoAction()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ENDUNDOACTION, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICSETSTYLE, indic, style);
        }

        /// <summary>Retrieve the style of an indicator. (Scintilla feature 2081)</summary>
        public int IndicGetStyle(int indic)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICGETSTYLE, indic, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICSETFORE, indic, fore.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICGETFORE, indic, Unused);
            return new Colour((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICSETUNDER, indic, under ? 1 : 0);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICGETUNDER, indic, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICSETHOVERSTYLE, indic, style);
        }

        /// <summary>Retrieve the hover style of an indicator. (Scintilla feature 2681)</summary>
        public int IndicGetHoverStyle(int indic)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICGETHOVERSTYLE, indic, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICSETHOVERFORE, indic, fore.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICGETHOVERFORE, indic, Unused);
            return new Colour((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICSETFLAGS, indic, flags);
        }

        /// <summary>Retrieve the attributes of an indicator. (Scintilla feature 2685)</summary>
        public int IndicGetFlags(int indic)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICGETFLAGS, indic, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETWHITESPACEFORE, useSetting ? 1 : 0, fore.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETWHITESPACEBACK, useSetting ? 1 : 0, back.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETWHITESPACESIZE, size, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETWHITESPACESIZE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSTYLEBITS, bits, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSTYLEBITS, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETLINESTATE, line, state);
        }

        /// <summary>Retrieve the extra styling information for a line. (Scintilla feature 2093)</summary>
        public int GetLineState(int line)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETLINESTATE, line, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMAXLINESTATE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCARETLINEVISIBLE, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETCARETLINEVISIBLE, show ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCARETLINEBACK, Unused, Unused);
            return new Colour((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETCARETLINEBACK, back.Value, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STYLESETCHANGEABLE, style, changeable ? 1 : 0);
        }
        ...
        public unsafe void AutoCShow(int lenEntered, string itemList)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSHOW, lenEntered, (IntPtr) itemListPtr);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCCANCEL, Unused, Unused);
        }

        /// <summary>Is there an auto-completion list visible? (Scintilla feature 2102)</summary>
        public bool AutoCActive()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCACTIVE, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCPOSSTART, Unused, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCCOMPLETE, Unused, Unused);
        }
        ...
        public unsafe void AutoCStops(string characterSet)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSTOPS, Unused, (IntPtr) characterSetPtr);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSETSEPARATOR, separatorCharacter, Unused);
        }

        /// <summary>Retrieve the auto-completion list separator character. (Scintilla feature 2107)</summary>
        public int AutoCGetSeparator()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCGETSEPARATOR, Unused, Unused);
            return (int) res;
        }
        ...
        public unsafe void AutoCSelect(string text)
        {
            fixed (byte* textPtr = Encoding.UTF8.GetBytes(text))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSELECT, Unused, (IntPtr) textPtr);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSETCANCELATSTART, cancel ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCGETCANCELATSTART, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        public unsafe void AutoCSetFillUps(string characterSet)
        {
            fixed (byte* characterSetPtr = Encoding.UTF8.GetBytes(characterSet))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSETFILLUPS, Unused, (IntPtr) characterSetPtr);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSETCHOOSESINGLE, chooseSingle ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCGETCHOOSESINGLE, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSETIGNORECASE, ignoreCase ? 1 : 0, Unused);
        }

        /// <summary>Retrieve state of ignore case flag. (Scintilla feature 2116)</summary>
        public bool AutoCGetIgnoreCase()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCGETIGNORECASE, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        public unsafe void UserListShow(int listType, string itemList)
        {
            fixed (byte* itemListPtr = Encoding.UTF8.GetBytes(itemList))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_USERLISTSHOW, listType, (IntPtr) itemListPtr);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSETAUTOHIDE, autoHide ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCGETAUTOHIDE, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSETDROPRESTOFWORD, dropRestOfWord ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCGETDROPRESTOFWORD, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        public unsafe void RegisterImage(int type, string xpmData)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_REGISTERIMAGE, type, (IntPtr) xpmDataPtr);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CLEARREGISTEREDIMAGES, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCGETTYPESEPARATOR, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSETTYPESEPARATOR, separatorCharacter, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSETMAXWIDTH, characterCount, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCGETMAXWIDTH, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSETMAXHEIGHT, rowCount, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCGETMAXHEIGHT, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETINDENT, indentSize, Unused);
        }

        /// <summary>Retrieve indentation size. (Scintilla feature 2123)</summary>
        public int GetIndent()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETINDENT, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETUSETABS, useTabs ? 1 : 0, Unused);
        }

        /// <summary>Retrieve whether tabs will be used in indentation. (Scintilla feature 2125)</summary>
        public bool GetUseTabs()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETUSETABS, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETLINEINDENTATION, line, indentSize);
        }

        /// <summary>Retrieve the number of columns that a line is indented. (Scintilla feature 2127)</summary>
        public int GetLineIndentation(int line)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETLINEINDENTATION, line, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETLINEINDENTPOSITION, line, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCOLUMN, pos.Value, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_COUNTCHARACTERS, startPos, endPos);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETHSCROLLBAR, show ? 1 : 0, Unused);
        }

        /// <summary>Is the horizontal scroll bar visible? (Scintilla feature 2131)</summary>
        public bool GetHScrollBar()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETHSCROLLBAR, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETINDENTATIONGUIDES, indentView, Unused);
        }

        /// <summary>Are the indentation guides visible? (Scintilla feature 2133)</summary>
        public int GetIndentationGuides()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETINDENTATIONGUIDES, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETHIGHLIGHTGUIDE, column, Unused);
        }

        /// <summary>Get the highlighted indentation guide column. (Scintilla feature 2135)</summary>
        public int GetHighlightGuide()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETHIGHLIGHTGUIDE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETLINEENDPOSITION, line, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCODEPAGE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCARETFORE, Unused, Unused);
            return new Colour((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETREADONLY, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETCURRENTPOS, pos.Value, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSELECTIONSTART, pos.Value, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSELECTIONSTART, Unused, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSELECTIONEND, pos.Value, Unused);
        }

        /// <summary>Returns the position at the end of the selection. (Scintilla feature 2145)</summary>
        public Position GetSelectionEnd()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSELECTIONEND, Unused, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETEMPTYSELECTION, pos.Value, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETPRINTMAGNIFICATION, magnification, Unused);
        }

        /// <summary>Returns the print magnification. (Scintilla feature 2147)</summary>
        public int GetPrintMagnification()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETPRINTMAGNIFICATION, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETPRINTCOLOURMODE, mode, Unused);
        }

        /// <summary>Returns the print colour mode. (Scintilla feature 2149)</summary>
        public int GetPrintColourMode()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETPRINTCOLOURMODE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_FINDTEXT, flags, ft.NativePointer);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETFIRSTVISIBLELINE, Unused, Unused);
            return (int) res;
        }
        ...
        public unsafe string GetLine(int line)
        {
            ...
            fixed (byte* textPtr = textBuffer)
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETLINE, line, (IntPtr) textPtr);
                return Encoding.UTF8.GetString(textBuffer).TrimEnd('\0');
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETLINECOUNT, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETMARGINLEFT, Unused, pixelWidth);
        }

        /// <summary>Returns the size in pixels of the left margin. (Scintilla feature 2156)</summary>
        public int GetMarginLeft()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMARGINLEFT, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETMARGINRIGHT, Unused, pixelWidth);
        }

        /// <summary>Returns the size in pixels of the right margin. (Scintilla feature 2158)</summary>
        public int GetMarginRight()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMARGINRIGHT, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMODIFY, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSEL, start.Value, end.Value);
        }
        ...
        public unsafe string GetSelText()
        {
            ...
            fixed (byte* textPtr = textBuffer)
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSELTEXT, Unused, (IntPtr) textPtr);
                return Encoding.UTF8.GetString(textBuffer).TrimEnd('\0');
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETTEXTRANGE, Unused, tr.NativePointer);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_HIDESELECTION, normal ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_POINTXFROMPOSITION, Unused, pos.Value);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_POINTYFROMPOSITION, Unused, pos.Value);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINEFROMPOSITION, pos.Value, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_POSITIONFROMLINE, line, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINESCROLL, columns, lines);
        }

        /// <summary>Ensure the caret is visible. (Scintilla feature 2169)</summary>
        public void ScrollCaret()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SCROLLCARET, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SCROLLRANGE, secondary.Value, primary.Value);
        }
        ...
        public unsafe void ReplaceSel(string text)
        {
            fixed (byte* textPtr = Encoding.UTF8.GetBytes(text))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_REPLACESEL, Unused, (IntPtr) textPtr);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETREADONLY, readOnly ? 1 : 0, Unused);
        }

        /// <summary>Null operation. (Scintilla feature 2172)</summary>
        public void Null()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_NULL, Unused, Unused);
        }

        /// <summary>Will a paste succeed? (Scintilla feature 2173)</summary>
        public bool CanPaste()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CANPASTE, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        public bool CanUndo()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CANUNDO, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        public unsafe void SetText(string text)
        {
            fixed (byte* textPtr = Encoding.UTF8.GetBytes(text))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETTEXT, Unused, (IntPtr) textPtr);
            }
        }
        ...
        public unsafe string GetText(int length)
        {
            ...
            fixed (byte* textPtr = textBuffer)
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETTEXT, length, (IntPtr) textPtr);
                return Encoding.UTF8.GetString(textBuffer).TrimEnd('\0');
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETTEXTLENGTH, Unused, Unused);
            return (int) res;
        }
        ...
        {
            return SendMessage(scintilla, SciMsg.SCI_GETDIRECTFUNCTION, Unused, Unused);
        }
        ...
        {
            return SendMessage(scintilla, SciMsg.SCI_GETDIRECTPOINTER, Unused, Unused);
        }

        /// <summary>Set to overtype (true) or insert mode. (Scintilla feature 2186)</summary>
        public void SetOvertype(bool overtype)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETOVERTYPE, overtype ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETOVERTYPE, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETCARETWIDTH, pixelWidth, Unused);
        }

        /// <summary>Returns the width of the insert mode caret. (Scintilla feature 2189)</summary>
        public int GetCaretWidth()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCARETWIDTH, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETTARGETSTART, pos.Value, Unused);
        }

        /// <summary>Get the position that starts the target. (Scintilla feature 2191)</summary>
        public Position GetTargetStart()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETTARGETSTART, Unused, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETTARGETEND, pos.Value, Unused);
        }

        /// <summary>Get the position that ends the target. (Scintilla feature 2193)</summary>
        public Position GetTargetEnd()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETTARGETEND, Unused, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETTARGETRANGE, start.Value, end.Value);
        }
        ...
        public unsafe string GetTargetText()
        {
            ...
            fixed (byte* charactersPtr = charactersBuffer)
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETTARGETTEXT, Unused, (IntPtr) charactersPtr);
                return Encoding.UTF8.GetString(charactersBuffer).TrimEnd('\0');
            }
        }
        ...
        public unsafe int ReplaceTarget(int length, string text)
        {
            fixed (byte* textPtr = Encoding.UTF8.GetBytes(text))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_REPLACETARGET, length, (IntPtr) textPtr);
                return (int) res;
            }
        }
        ...
        public unsafe int ReplaceTargetRE(int length, string text)
        {
            fixed (byte* textPtr = Encoding.UTF8.GetBytes(text))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_REPLACETARGETRE, length, (IntPtr) textPtr);
                return (int) res;
            }
        }
        ...
        public unsafe int SearchInTarget(int length, string text)
        {
            fixed (byte* textPtr = Encoding.UTF8.GetBytes(text))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_SEARCHINTARGET, length, (IntPtr) textPtr);
                return (int) res;
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSEARCHFLAGS, flags, Unused);
        }

        /// <summary>Get the search flags used by SearchInTarget. (Scintilla feature 2199)</summary>
        public int GetSearchFlags()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSEARCHFLAGS, Unused, Unused);
            return (int) res;
        }
        ...
        public unsafe void CallTipShow(Position pos, string definition)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_CALLTIPSHOW, pos.Value, (IntPtr) definitionPtr);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CALLTIPCANCEL, Unused, Unused);
        }

        /// <summary>Is there an active call tip? (Scintilla feature 2202)</summary>
        public bool CallTipActive()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CALLTIPACTIVE, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CALLTIPPOSSTART, Unused, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CALLTIPSETFOREHLT, fore.Value, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CALLTIPUSESTYLE, tabSize, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CALLTIPSETPOSITION, above ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_VISIBLEFROMDOCLINE, line, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_DOCLINEFROMVISIBLE, lineDisplay, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_WRAPCOUNT, line, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETFOLDLEVEL, line, level);
        }

        /// <summary>Retrieve the fold level of a line. (Scintilla feature 2223)</summary>
        public int GetFoldLevel(int line)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETFOLDLEVEL, line, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETLASTCHILD, line, level);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETFOLDPARENT, line, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SHOWLINES, lineStart, lineEnd);
        }

        /// <summary>Make a range of lines invisible. (Scintilla feature 2227)</summary>
        public void HideLines(int lineStart, int lineEnd)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_HIDELINES, lineStart, lineEnd);
        }

        /// <summary>Is a line visible? (Scintilla feature 2228)</summary>
        public bool GetLineVisible(int line)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETLINEVISIBLE, line, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETALLLINESVISIBLE, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETFOLDEXPANDED, line, expanded ? 1 : 0);
        }

        /// <summary>Is a header line expanded? (Scintilla feature 2230)</summary>
        public bool GetFoldExpanded(int line)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETFOLDEXPANDED, line, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_TOGGLEFOLD, line, Unused);
        }

        /// <summary>Expand or contract a fold header. (Scintilla feature 2237)</summary>
        public void FoldLine(int line, int action)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_FOLDLINE, line, action);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_FOLDCHILDREN, line, action);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_EXPANDCHILDREN, line, level);
        }

        /// <summary>Expand or contract all fold headers. (Scintilla feature 2662)</summary>
        public void FoldAll(int action)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_FOLDALL, action, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ENSUREVISIBLE, line, Unused);
        }

        /// <summary>Set automatic folding behaviours. (Scintilla feature 2663)</summary>
        public void SetAutomaticFold(int automaticFold)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETAUTOMATICFOLD, automaticFold, Unused);
        }

        /// <summary>Get automatic folding behaviours. (Scintilla feature 2664)</summary>
        public int GetAutomaticFold()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETAUTOMATICFOLD, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETFOLDFLAGS, flags, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ENSUREVISIBLEENFORCEPOLICY, line, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETTABINDENTS, tabIndents ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETTABINDENTS, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETBACKSPACEUNINDENTS, bsUnIndents ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETBACKSPACEUNINDENTS, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETMOUSEDWELLTIME, periodMilliseconds, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMOUSEDWELLTIME, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_WORDSTARTPOSITION, pos.Value, onlyWordCharacters ? 1 : 0);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_WORDENDPOSITION, pos.Value, onlyWordCharacters ? 1 : 0);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETWRAPMODE, mode, Unused);
        }

        /// <summary>Retrieve whether text is word wrapped. (Scintilla feature 2269)</summary>
        public int GetWrapMode()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETWRAPMODE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETWRAPVISUALFLAGS, wrapVisualFlags, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETWRAPVISUALFLAGS, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETWRAPVISUALFLAGSLOCATION, wrapVisualFlagsLocation, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETWRAPVISUALFLAGSLOCATION, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETWRAPSTARTINDENT, indent, Unused);
        }

        /// <summary>Retrive the start indent for wrapped lines. (Scintilla feature 2465)</summary>
        public int GetWrapStartIndent()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETWRAPSTARTINDENT, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETWRAPINDENTMODE, mode, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETWRAPINDENTMODE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETLAYOUTCACHE, mode, Unused);
        }

        /// <summary>Retrieve the degree of caching of layout information. (Scintilla feature 2273)</summary>
        public int GetLayoutCache()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETLAYOUTCACHE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSCROLLWIDTH, pixelWidth, Unused);
        }

        /// <summary>Retrieve the document width assumed for scrolling. (Scintilla feature 2275)</summary>
        public int GetScrollWidth()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSCROLLWIDTH, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSCROLLWIDTHTRACKING, tracking ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSCROLLWIDTHTRACKING, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        public unsafe int TextWidth(int style, string text)
        {
            fixed (byte* textPtr = Encoding.UTF8.GetBytes(text))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_TEXTWIDTH, style, (IntPtr) textPtr);
                return (int) res;
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETENDATLASTLINE, endAtLastLine ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETENDATLASTLINE, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_TEXTHEIGHT, line, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETVSCROLLBAR, show ? 1 : 0, Unused);
        }

        /// <summary>Is the vertical scroll bar visible? (Scintilla feature 2281)</summary>
        public bool GetVScrollBar()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETVSCROLLBAR, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        public unsafe void AppendText(int length, string text)
        {
            fixed (byte* textPtr = Encoding.UTF8.GetBytes(text))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_APPENDTEXT, length, (IntPtr) textPtr);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETTWOPHASEDRAW, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETTWOPHASEDRAW, twoPhase ? 1 : 0, Unused);
        }

        /// <summary>How many phases is drawing done in? (Scintilla feature 2673)</summary>
        public int GetPhasesDraw()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETPHASESDRAW, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETPHASESDRAW, phases, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETFONTQUALITY, fontQuality, Unused);
        }

        /// <summary>Retrieve the quality level for text. (Scintilla feature 2612)</summary>
        public int GetFontQuality()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETFONTQUALITY, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETFIRSTVISIBLELINE, lineDisplay, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETMULTIPASTE, multiPaste, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMULTIPASTE, Unused, Unused);
            return (int) res;
        }
        ...
        public unsafe string GetTag(int tagNumber)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETTAG, tagNumber, (IntPtr) tagValuePtr);
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_TARGETFROMSELECTION, Unused, Unused);
        }

        /// <summary>Join the lines in the target. (Scintilla feature 2288)</summary>
        public void LinesJoin()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINESJOIN, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINESSPLIT, pixelWidth, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETFOLDMARGINCOLOUR, useSetting ? 1 : 0, back.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETFOLDMARGINHICOLOUR, useSetting ? 1 : 0, fore.Value);
        }

        /// <summary>Move caret down one line. (Scintilla feature 2300)</summary>
        public void LineDown()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINEDOWN, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINEDOWNEXTEND, Unused, Unused);
        }

        /// <summary>Move caret up one line. (Scintilla feature 2302)</summary>
        public void LineUp()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINEUP, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINEUPEXTEND, Unused, Unused);
        }

        /// <summary>Move caret left one character. (Scintilla feature 2304)</summary>
        public void CharLeft()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CHARLEFT, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CHARLEFTEXTEND, Unused, Unused);
        }

        /// <summary>Move caret right one character. (Scintilla feature 2306)</summary>
        public void CharRight()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CHARRIGHT, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CHARRIGHTEXTEND, Unused, Unused);
        }

        /// <summary>Move caret left one word. (Scintilla feature 2308)</summary>
        public void WordLeft()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_WORDLEFT, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_WORDLEFTEXTEND, Unused, Unused);
        }

        /// <summary>Move caret right one word. (Scintilla feature 2310)</summary>
        public void WordRight()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_WORDRIGHT, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_WORDRIGHTEXTEND, Unused, Unused);
        }

        /// <summary>Move caret to first position on line. (Scintilla feature 2312)</summary>
        public void Home()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_HOME, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_HOMEEXTEND, Unused, Unused);
        }

        /// <summary>Move caret to last position on line. (Scintilla feature 2314)</summary>
        public void LineEnd()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINEEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINEENDEXTEND, Unused, Unused);
        }

        /// <summary>Move caret to first position in document. (Scintilla feature 2316)</summary>
        public void DocumentStart()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_DOCUMENTSTART, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_DOCUMENTSTARTEXTEND, Unused, Unused);
        }

        /// <summary>Move caret to last position in document. (Scintilla feature 2318)</summary>
        public void DocumentEnd()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_DOCUMENTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_DOCUMENTENDEXTEND, Unused, Unused);
        }

        /// <summary>Move caret one page up. (Scintilla feature 2320)</summary>
        public void PageUp()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_PAGEUP, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_PAGEUPEXTEND, Unused, Unused);
        }

        /// <summary>Move caret one page down. (Scintilla feature 2322)</summary>
        public void PageDown()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_PAGEDOWN, Unused, Unused);
        }
        ...
        public void Tab()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_TAB, Unused, Unused);
        }

        /// <summary>Dedent the selected lines. (Scintilla feature 2328)</summary>
        public void BackTab()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_BACKTAB, Unused, Unused);
        }

        /// <summary>Insert a new line, may use a CRLF, CR or LF depending on EOL mode. (Scintilla feature 2329)</summary>
        public void NewLine()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_NEWLINE, Unused, Unused);
        }

        /// <summary>Insert a Form Feed character. (Scintilla feature 2330)</summary>
        public void FormFeed()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_FORMFEED, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_DELETEBACKNOTLINE, Unused, Unused);
        }

        /// <summary>Move caret to first position on display line. (Scintilla feature 2345)</summary>
        public void HomeDisplay()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_HOMEDISPLAY, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_HOMEDISPLAYEXTEND, Unused, Unused);
        }

        /// <summary>Move caret to last position on display line. (Scintilla feature 2347)</summary>
        public void LineEndDisplay()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINEENDDISPLAY, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINEENDDISPLAYEXTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_HOMEWRAP, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_HOMEWRAPEXTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINEENDWRAP, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINEENDWRAPEXTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_VCHOMEWRAP, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_VCHOMEWRAPEXTEND, Unused, Unused);
        }

        /// <summary>Copy the line containing the caret. (Scintilla feature 2455)</summary>
        public void LineCopy()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINECOPY, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MOVECARETINSIDEVIEW, Unused, Unused);
        }

        /// <summary>How many characters are on a line, including end of line characters? (Scintilla feature 2350)</summary>
        public int LineLength(int line)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINELENGTH, line, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_BRACEHIGHLIGHT, pos1.Value, pos2.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_BRACEHIGHLIGHTINDICATOR, useBraceHighlightIndicator ? 1 : 0, indicator);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_BRACEBADLIGHT, pos.Value, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_BRACEBADLIGHTINDICATOR, useBraceBadLightIndicator ? 1 : 0, indicator);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_BRACEMATCH, pos.Value, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETVIEWEOL, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETMODEVENTMASK, mask, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETEDGECOLUMN, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETEDGECOLUMN, column, Unused);
        }

        /// <summary>Retrieve the edge highlight mode. (Scintilla feature 2362)</summary>
        public int GetEdgeMode()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETEDGEMODE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETEDGEMODE, mode, Unused);
        }

        /// <summary>Retrieve the colour used in edge indication. (Scintilla feature 2364)</summary>
        public Colour GetEdgeColour()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETEDGECOLOUR, Unused, Unused);
            return new Colour((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETEDGECOLOUR, edgeColour.Value, Unused);
        }

        /// <summary>Sets the current caret position to be the search anchor. (Scintilla feature 2366)</summary>
        public void SearchAnchor()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SEARCHANCHOR, Unused, Unused);
        }
        ...
        public unsafe int SearchNext(int flags, string text)
        {
            fixed (byte* textPtr = Encoding.UTF8.GetBytes(text))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_SEARCHNEXT, flags, (IntPtr) textPtr);
                return (int) res;
            }
        }
        ...
        public unsafe int SearchPrev(int flags, string text)
        {
            fixed (byte* textPtr = Encoding.UTF8.GetBytes(text))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_SEARCHPREV, flags, (IntPtr) textPtr);
                return (int) res;
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINESONSCREEN, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_USEPOPUP, allowPopUp ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SELECTIONISRECTANGLE, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETZOOM, zoom, Unused);
        }

        /// <summary>Retrieve the zoom level. (Scintilla feature 2374)</summary>
        public int GetZoom()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETZOOM, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CREATEDOCUMENT, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ADDREFDOCUMENT, Unused, doc);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_RELEASEDOCUMENT, Unused, doc);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMODEVENTMASK, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETFOCUS, focus ? 1 : 0, Unused);
        }

        /// <summary>Get internal focus flag. (Scintilla feature 2381)</summary>
        public bool GetFocus()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETFOCUS, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSTATUS, statusCode, Unused);
        }

        /// <summary>Get error status. (Scintilla feature 2383)</summary>
        public int GetStatus()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSTATUS, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETMOUSEDOWNCAPTURES, captures ? 1 : 0, Unused);
        }

        /// <summary>Get whether mouse gets captured. (Scintilla feature 2385)</summary>
        public bool GetMouseDownCaptures()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMOUSEDOWNCAPTURES, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETCURSOR, cursorType, Unused);
        }

        /// <summary>Get cursor type. (Scintilla feature 2387)</summary>
        public int GetCursor()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCURSOR, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETCONTROLCHARSYMBOL, symbol, Unused);
        }

        /// <summary>Get the way control characters are displayed. (Scintilla feature 2389)</summary>
        public int GetControlCharSymbol()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCONTROLCHARSYMBOL, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_WORDPARTLEFT, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_WORDPARTLEFTEXTEND, Unused, Unused);
        }

        /// <summary>Move to the change next in capitalisation. (Scintilla feature 2392)</summary>
        public void WordPartRight()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_WORDPARTRIGHT, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_WORDPARTRIGHTEXTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETVISIBLEPOLICY, visiblePolicy, visibleSlop);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_DELLINELEFT, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_DELLINERIGHT, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETXOFFSET, newOffset, Unused);
        }

        /// <summary>Get and Set the xOffset (ie, horizontal scroll position). (Scintilla feature 2398)</summary>
        public int GetXOffset()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETXOFFSET, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CHOOSECARETX, Unused, Unused);
        }

        /// <summary>Set the focus to this Scintilla widget. (Scintilla feature 2400)</summary>
        public void GrabFocus()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GRABFOCUS, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETXCARETPOLICY, caretPolicy, caretSlop);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETYCARETPOLICY, caretPolicy, caretSlop);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETPRINTWRAPMODE, mode, Unused);
        }

        /// <summary>Is printing line wrapped? (Scintilla feature 2407)</summary>
        public int GetPrintWrapMode()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETPRINTWRAPMODE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETHOTSPOTACTIVEFORE, useSetting ? 1 : 0, fore.Value);
        }

        /// <summary>Get the fore colour for active hotspots. (Scintilla feature 2494)</summary>
        public Colour GetHotspotActiveFore()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETHOTSPOTACTIVEFORE, Unused, Unused);
            return new Colour((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETHOTSPOTACTIVEBACK, useSetting ? 1 : 0, back.Value);
        }

        /// <summary>Get the back colour for active hotspots. (Scintilla feature 2495)</summary>
        public Colour GetHotspotActiveBack()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETHOTSPOTACTIVEBACK, Unused, Unused);
            return new Colour((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETHOTSPOTACTIVEUNDERLINE, underline ? 1 : 0, Unused);
        }

        /// <summary>Get whether underlining for active hotspots. (Scintilla feature 2496)</summary>
        public bool GetHotspotActiveUnderline()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETHOTSPOTACTIVEUNDERLINE, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETHOTSPOTSINGLELINE, singleLine ? 1 : 0, Unused);
        }

        /// <summary>Get the HotspotSingleLine property (Scintilla feature 2497)</summary>
        public bool GetHotspotSingleLine()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETHOTSPOTSINGLELINE, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_POSITIONBEFORE, pos.Value, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_POSITIONAFTER, pos.Value, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_POSITIONRELATIVE, pos.Value, relative);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_COPYRANGE, start.Value, end.Value);
        }
        ...
        public unsafe void CopyText(int length, string text)
        {
            fixed (byte* textPtr = Encoding.UTF8.GetBytes(text))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_COPYTEXT, length, (IntPtr) textPtr);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSELECTIONMODE, mode, Unused);
        }

        /// <summary>Get the mode of the current selection. (Scintilla feature 2423)</summary>
        public int GetSelectionMode()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSELECTIONMODE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETLINESELSTARTPOSITION, line, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETLINESELENDPOSITION, line, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINEDOWNRECTEXTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINEUPRECTEXTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CHARLEFTRECTEXTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CHARRIGHTRECTEXTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_HOMERECTEXTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_VCHOMERECTEXTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_LINEENDRECTEXTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_PAGEUPRECTEXTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_PAGEDOWNRECTEXTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STUTTEREDPAGEUP, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STUTTEREDPAGEUPEXTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STUTTEREDPAGEDOWN, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_STUTTEREDPAGEDOWNEXTEND, Unused, Unused);
        }

        /// <summary>Move caret left one word, position cursor at end of word. (Scintilla feature 2439)</summary>
        public void WordLeftEnd()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_WORDLEFTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_WORDLEFTENDEXTEND, Unused, Unused);
        }

        /// <summary>Move caret right one word, position cursor at end of word. (Scintilla feature 2441)</summary>
        public void WordRightEnd()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_WORDRIGHTEND, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_WORDRIGHTENDEXTEND, Unused, Unused);
        }
        ...
        public unsafe void SetWhitespaceChars(string characters)
        {
            fixed (byte* charactersPtr = Encoding.UTF8.GetBytes(characters))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETWHITESPACECHARS, Unused, (IntPtr) charactersPtr);
            }
        }
        ...
        public unsafe string GetWhitespaceChars()
        {
            ...
            fixed (byte* charactersPtr = charactersBuffer)
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETWHITESPACECHARS, Unused, (IntPtr) charactersPtr);
                return Encoding.UTF8.GetString(charactersBuffer).TrimEnd('\0');
            }
        }
        ...
        public unsafe void SetPunctuationChars(string characters)
        {
            fixed (byte* charactersPtr = Encoding.UTF8.GetBytes(characters))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETPUNCTUATIONCHARS, Unused, (IntPtr) charactersPtr);
            }
        }
        ...
        public unsafe string GetPunctuationChars()
        {
            ...
            fixed (byte* charactersPtr = charactersBuffer)
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETPUNCTUATIONCHARS, Unused, (IntPtr) charactersPtr);
                return Encoding.UTF8.GetString(charactersBuffer).TrimEnd('\0');
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETCHARSDEFAULT, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCGETCURRENT, Unused, Unused);
            return (int) res;
        }
        ...
        public unsafe string AutoCGetCurrentText()
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCGETCURRENTTEXT, Unused, (IntPtr) sPtr);
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSETCASEINSENSITIVEBEHAVIOUR, behaviour, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCGETCASEINSENSITIVEBEHAVIOUR, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSETMULTI, multi, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCGETMULTI, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCSETORDER, order, Unused);
        }

        /// <summary>Get the way autocompletion lists are ordered. (Scintilla feature 2661)</summary>
        public int AutoCGetOrder()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_AUTOCGETORDER, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ALLOCATE, bytes, Unused);
        }
        ...
        public unsafe string TargetAsUTF8()
        {
            ...
            fixed (byte* sPtr = sBuffer)
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_TARGETASUTF8, Unused, (IntPtr) sPtr);
                return Encoding.UTF8.GetString(sBuffer).TrimEnd('\0');
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETLENGTHFORENCODE, bytes, Unused);
        }
        ...
        public unsafe string EncodedFromUTF8(string utf8)
        {
            fixed (byte* utf8Ptr = Encoding.UTF8.GetBytes(utf8))
            {
                ...
                {
                    IntPtr res = SendMessage(scintilla, SciMsg.SCI_ENCODEDFROMUTF8, (IntPtr) utf8Ptr, (IntPtr) encodedPtr);
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_FINDCOLUMN, line, column);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCARETSTICKY, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETCARETSTICKY, useCaretStickyBehaviour, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_TOGGLECARETSTICKY, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETPASTECONVERTENDINGS, convert ? 1 : 0, Unused);
        }

        /// <summary>Get convert-on-paste setting (Scintilla feature 2468)</summary>
        public bool GetPasteConvertEndings()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETPASTECONVERTENDINGS, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SELECTIONDUPLICATE, Unused, Unused);
        }

        /// <summary>Set background alpha of the caret line. (Scintilla feature 2470)</summary>
        public void SetCaretLineBackAlpha(int alpha)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETCARETLINEBACKALPHA, alpha, Unused);
        }

        /// <summary>Get the background alpha of the caret line. (Scintilla feature 2471)</summary>
        public int GetCaretLineBackAlpha()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCARETLINEBACKALPHA, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETCARETSTYLE, caretStyle, Unused);
        }

        /// <summary>Returns the current style of the caret. (Scintilla feature 2513)</summary>
        public int GetCaretStyle()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCARETSTYLE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETINDICATORCURRENT, indicator, Unused);
        }

        /// <summary>Get the current indicator (Scintilla feature 2501)</summary>
        public int GetIndicatorCurrent()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETINDICATORCURRENT, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETINDICATORVALUE, value, Unused);
        }

        /// <summary>Get the current indicator value (Scintilla feature 2503)</summary>
        public int GetIndicatorValue()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETINDICATORVALUE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICATORFILLRANGE, position, fillLength);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICATORCLEARRANGE, position, clearLength);
        }

        /// <summary>Are any indicators present at position? (Scintilla feature 2506)</summary>
        public int IndicatorAllOnFor(int position)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICATORALLONFOR, position, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICATORVALUEAT, indicator, position);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICATORSTART, indicator, position);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICATOREND, indicator, position);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETPOSITIONCACHE, size, Unused);
        }

        /// <summary>How many entries are allocated to the position cache? (Scintilla feature 2515)</summary>
        public int GetPositionCache()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETPOSITIONCACHE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_COPYALLOWLINE, Unused, Unused);
        }
        ...
        {
            return SendMessage(scintilla, SciMsg.SCI_GETCHARACTERPOINTER, Unused, Unused);
        }
        ...
        {
            return SendMessage(scintilla, SciMsg.SCI_GETRANGEPOINTER, position, rangeLength);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETGAPPOSITION, Unused, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICSETALPHA, indicator, alpha);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICGETALPHA, indicator, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICSETOUTLINEALPHA, indicator, alpha);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_INDICGETOUTLINEALPHA, indicator, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETEXTRAASCENT, extraAscent, Unused);
        }

        /// <summary>Get extra ascent for each line (Scintilla feature 2526)</summary>
        public int GetExtraAscent()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETEXTRAASCENT, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETEXTRADESCENT, extraDescent, Unused);
        }

        /// <summary>Get extra descent for each line (Scintilla feature 2528)</summary>
        public int GetExtraDescent()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETEXTRADESCENT, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERSYMBOLDEFINED, markerNumber, Unused);
            return (int) res;
        }
        ...
        public unsafe void MarginSetText(int line, string text)
        {
            fixed (byte* textPtr = Encoding.UTF8.GetBytes(text))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARGINSETTEXT, line, (IntPtr) textPtr);
            }
        }
        ...
        public unsafe string MarginGetText(int line)
        {
            ...
            fixed (byte* textPtr = textBuffer)
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARGINGETTEXT, line, (IntPtr) textPtr);
                return Encoding.UTF8.GetString(textBuffer).TrimEnd('\0');
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARGINSETSTYLE, line, style);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARGINGETSTYLE, line, Unused);
            return (int) res;
        }
        ...
        public unsafe void MarginSetStyles(int line, string styles)
        {
            fixed (byte* stylesPtr = Encoding.UTF8.GetBytes(styles))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARGINSETSTYLES, line, (IntPtr) stylesPtr);
            }
        }
        ...
        public unsafe string MarginGetStyles(int line)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARGINGETSTYLES, line, (IntPtr) stylesPtr);
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARGINTEXTCLEARALL, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARGINSETSTYLEOFFSET, style, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARGINGETSTYLEOFFSET, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETMARGINOPTIONS, marginOptions, Unused);
        }

        /// <summary>Get the margin options. (Scintilla feature 2557)</summary>
        public int GetMarginOptions()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMARGINOPTIONS, Unused, Unused);
            return (int) res;
        }
        ...
        public unsafe void AnnotationSetText(int line, string text)
        {
            fixed (byte* textPtr = Encoding.UTF8.GetBytes(text))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_ANNOTATIONSETTEXT, line, (IntPtr) textPtr);
            }
        }
        ...
        public unsafe string AnnotationGetText(int line)
        {
            ...
            fixed (byte* textPtr = textBuffer)
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_ANNOTATIONGETTEXT, line, (IntPtr) textPtr);
                return Encoding.UTF8.GetString(textBuffer).TrimEnd('\0');
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ANNOTATIONSETSTYLE, line, style);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ANNOTATIONGETSTYLE, line, Unused);
            return (int) res;
        }
        ...
        public unsafe void AnnotationSetStyles(int line, string styles)
        {
            fixed (byte* stylesPtr = Encoding.UTF8.GetBytes(styles))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_ANNOTATIONSETSTYLES, line, (IntPtr) stylesPtr);
            }
        }
        ...
        public unsafe string AnnotationGetStyles(int line)
        {
            ...
            fixed (byte* stylesPtr = stylesBuffer)
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_ANNOTATIONGETSTYLES, line, (IntPtr) stylesPtr);
                return Encoding.UTF8.GetString(stylesBuffer).TrimEnd('\0');
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ANNOTATIONGETLINES, line, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ANNOTATIONCLEARALL, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ANNOTATIONSETVISIBLE, visible, Unused);
        }

        /// <summary>Get the visibility for the annotations for a view (Scintilla feature 2549)</summary>
        public int AnnotationGetVisible()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ANNOTATIONGETVISIBLE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ANNOTATIONSETSTYLEOFFSET, style, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ANNOTATIONGETSTYLEOFFSET, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_RELEASEALLEXTENDEDSTYLES, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ALLOCATEEXTENDEDSTYLES, numberStyles, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ADDUNDOACTION, token, flags);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CHARPOSITIONFROMPOINT, x, y);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CHARPOSITIONFROMPOINTCLOSE, x, y);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETMOUSESELECTIONRECTANGULARSWITCH, mouseSelectionRectangularSwitch ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMOUSESELECTIONRECTANGULARSWITCH, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETMULTIPLESELECTION, multipleSelection ? 1 : 0, Unused);
        }

        /// <summary>Whether multiple selections can be made (Scintilla feature 2564)</summary>
        public bool GetMultipleSelection()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMULTIPLESELECTION, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETADDITIONALSELECTIONTYPING, additionalSelectionTyping ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETADDITIONALSELECTIONTYPING, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETADDITIONALCARETSBLINK, additionalCaretsBlink ? 1 : 0, Unused);
        }

        /// <summary>Whether additional carets will blink (Scintilla feature 2568)</summary>
        public bool GetAdditionalCaretsBlink()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETADDITIONALCARETSBLINK, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETADDITIONALCARETSVISIBLE, additionalCaretsBlink ? 1 : 0, Unused);
        }

        /// <summary>Whether additional carets are visible (Scintilla feature 2609)</summary>
        public bool GetAdditionalCaretsVisible()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETADDITIONALCARETSVISIBLE, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSELECTIONS, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSELECTIONEMPTY, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CLEARSELECTIONS, Unused, Unused);
        }

        /// <summary>Set a simple selection (Scintilla feature 2572)</summary>
        public int SetSelection(int caret, int anchor)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSELECTION, caret, anchor);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ADDSELECTION, caret, anchor);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_DROPSELECTIONN, selection, Unused);
        }

        /// <summary>Set the main selection (Scintilla feature 2574)</summary>
        public void SetMainSelection(int selection)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETMAINSELECTION, selection, Unused);
        }

        /// <summary>Which selection is the main selection (Scintilla feature 2575)</summary>
        public int GetMainSelection()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETMAINSELECTION, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSELECTIONNCARET, selection, pos.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSELECTIONNCARET, selection, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSELECTIONNANCHOR, selection, posAnchor.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSELECTIONNANCHOR, selection, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSELECTIONNCARETVIRTUALSPACE, selection, space);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSELECTIONNCARETVIRTUALSPACE, selection, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSELECTIONNANCHORVIRTUALSPACE, selection, space);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSELECTIONNANCHORVIRTUALSPACE, selection, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSELECTIONNSTART, selection, pos.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSELECTIONNSTART, selection, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETSELECTIONNEND, selection, pos.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSELECTIONNEND, selection, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETRECTANGULARSELECTIONCARET, pos.Value, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETRECTANGULARSELECTIONCARET, Unused, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETRECTANGULARSELECTIONANCHOR, posAnchor.Value, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETRECTANGULARSELECTIONANCHOR, Unused, Unused);
            return new Position((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETRECTANGULARSELECTIONCARETVIRTUALSPACE, space, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETRECTANGULARSELECTIONCARETVIRTUALSPACE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETRECTANGULARSELECTIONANCHORVIRTUALSPACE, space, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETRECTANGULARSELECTIONANCHORVIRTUALSPACE, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETVIRTUALSPACEOPTIONS, virtualSpaceOptions, Unused);
        }

        /// <summary>Returns the position at the end of the selection. (Scintilla feature 2597)</summary>
        public int GetVirtualSpaceOptions()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETVIRTUALSPACEOPTIONS, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETRECTANGULARSELECTIONMODIFIER, modifier, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETRECTANGULARSELECTIONMODIFIER, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETADDITIONALSELFORE, fore.Value, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETADDITIONALSELBACK, back.Value, Unused);
        }

        /// <summary>Set the alpha of the selection. (Scintilla feature 2602)</summary>
        public void SetAdditionalSelAlpha(int alpha)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETADDITIONALSELALPHA, alpha, Unused);
        }

        /// <summary>Get the alpha of the selection. (Scintilla feature 2603)</summary>
        public int GetAdditionalSelAlpha()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETADDITIONALSELALPHA, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETADDITIONALCARETFORE, fore.Value, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETADDITIONALCARETFORE, Unused, Unused);
            return new Colour((int) res);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ROTATESELECTION, Unused, Unused);
        }

        /// <summary>Swap that caret and anchor of the main selection. (Scintilla feature 2607)</summary>
        public void SwapMainAnchorCaret()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SWAPMAINANCHORCARET, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CHANGELEXERSTATE, start.Value, end.Value);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CONTRACTEDFOLDNEXT, lineStart, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_VERTICALCENTRECARET, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MOVESELECTEDLINESUP, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_MOVESELECTEDLINESDOWN, Unused, Unused);
        }

        /// <summary>Set the identifier reported as IdFrom in notification messages. (Scintilla feature 2622)</summary>
        public void SetIdentifier(int identifier)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETIDENTIFIER, identifier, Unused);
        }

        /// <summary>Get the identifier. (Scintilla feature 2623)</summary>
        public int GetIdentifier()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETIDENTIFIER, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_RGBAIMAGESETWIDTH, width, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_RGBAIMAGESETHEIGHT, height, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_RGBAIMAGESETSCALE, scalePercent, Unused);
        }
        ...
        public unsafe void MarkerDefineRGBAImage(int markerNumber, string pixels)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_MARKERDEFINERGBAIMAGE, markerNumber, (IntPtr) pixelsPtr);
            }
        }
        ...
        public unsafe void RegisterRGBAImage(int type, string pixels)
        {
            fixed (byte* pixelsPtr = Encoding.UTF8.GetBytes(pixels))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_REGISTERRGBAIMAGE, type, (IntPtr) pixelsPtr);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SCROLLTOSTART, Unused, Unused);
        }

        /// <summary>Scroll to end of document. (Scintilla feature 2629)</summary>
        public void ScrollToEnd()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SCROLLTOEND, Unused, Unused);
        }

        /// <summary>Set the technology used. (Scintilla feature 2630)</summary>
        public void SetTechnology(int technology)
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETTECHNOLOGY, technology, Unused);
        }

        /// <summary>Get the tech. (Scintilla feature 2631)</summary>
        public int GetTechnology()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETTECHNOLOGY, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_CREATELOADER, bytes, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_FINDINDICATORSHOW, start.Value, end.Value);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_FINDINDICATORFLASH, start.Value, end.Value);
        }

        /// <summary>On OS X, hide the find indicator. (Scintilla feature 2642)</summary>
        public void FindIndicatorHide()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_FINDINDICATORHIDE, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_VCHOMEDISPLAY, Unused, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_VCHOMEDISPLAYEXTEND, Unused, Unused);
        }

        /// <summary>Is the caret line always visible? (Scintilla feature 2654)</summary>
        public bool GetCaretLineVisibleAlways()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETCARETLINEVISIBLEALWAYS, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETCARETLINEVISIBLEALWAYS, alwaysVisible ? 1 : 0, Unused);
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETLINEENDTYPESALLOWED, lineEndBitSet, Unused);
        }

        /// <summary>Get the line end types currently allowed. (Scintilla feature 2657)</summary>
        public int GetLineEndTypesAllowed()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETLINEENDTYPESALLOWED, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETLINEENDTYPESACTIVE, Unused, Unused);
            return (int) res;
        }
        ...
        public unsafe void SetRepresentation(string encodedCharacter, string representation)
        {
            fixed (byte* encodedCharacterPtr = Encoding.UTF8.GetBytes(encodedCharacter))
            {
                ...
                {
                    IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETREPRESENTATION, (IntPtr) encodedCharacterPtr, (IntPtr) representationPtr);
                }
            }
        }
        ...
        public unsafe string GetRepresentation(string encodedCharacter)
        {
            fixed (byte* encodedCharacterPtr = Encoding.UTF8.GetBytes(encodedCharacter))
            {
                ...
                {
                    IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETREPRESENTATION, (IntPtr) encodedCharacterPtr, (IntPtr) representationPtr);
        ...
        public unsafe void ClearRepresentation(string encodedCharacter)
        {
            fixed (byte* encodedCharacterPtr = Encoding.UTF8.GetBytes(encodedCharacter))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_CLEARREPRESENTATION, (IntPtr) encodedCharacterPtr, Unused);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_COLOURISE, start.Value, end.Value);
        }
        ...
        public unsafe void SetProperty(string key, string value)
        {
            fixed (byte* keyPtr = Encoding.UTF8.GetBytes(key))
            {
                ...
                {
                    IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETPROPERTY, (IntPtr) keyPtr, (IntPtr) valuePtr);
                }
            }
        }
        ...
        public unsafe void SetKeyWords(int keywordSet, string keyWords)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETKEYWORDS, keywordSet, (IntPtr) keyWordsPtr);
            }
        }
        ...
        public unsafe void SetLexerLanguage(string language)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_SETLEXERLANGUAGE, Unused, (IntPtr) languagePtr);
            }
        }
        ...
        public unsafe void LoadLexerLibrary(string path)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_LOADLEXERLIBRARY, Unused, (IntPtr) pathPtr);
            }
        }
        ...
        public unsafe string GetProperty(string key)
        {
            fixed (byte* keyPtr = Encoding.UTF8.GetBytes(key))
            {
                ...
                {
                    IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETPROPERTY, (IntPtr) keyPtr, (IntPtr) bufPtr);
        ...
        public unsafe string GetPropertyExpanded(string key)
        {
            fixed (byte* keyPtr = Encoding.UTF8.GetBytes(key))
            {
                ...
                fixed (byte* bufPtr = bufBuffer)
                {
                    IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETPROPERTYEXPANDED, (IntPtr) keyPtr, (IntPtr) bufPtr);
                    return Encoding.UTF8.GetString(bufBuffer).TrimEnd('\0');
                }
            }
        }
        ...
        public unsafe int GetPropertyInt(string key)
        {
            fixed (byte* keyPtr = Encoding.UTF8.GetBytes(key))
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETPROPERTYINT, (IntPtr) keyPtr, Unused);
                return (int) res;
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSTYLEBITSNEEDED, Unused, Unused);
            return (int) res;
        }
        ...
        public unsafe string GetLexerLanguage()
        {
            ...
            fixed (byte* textPtr = textBuffer)
            {
                SendMessage(scintilla, SciMsg.SCI_GETLEXERLANGUAGE, Unused, (IntPtr) textPtr);
                return Encoding.UTF8.GetString(textBuffer).TrimEnd('\0');
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_PRIVATELEXERCALL, operation, pointer);
            return (int) res;
        }
        ...
        public unsafe string PropertyNames()
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_PROPERTYNAMES, Unused, (IntPtr) namesPtr);
        ...
        public unsafe int PropertyType(string name)
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_PROPERTYTYPE, (IntPtr) namePtr, Unused);
                return (int) res;
            }
        }
        ...
        public unsafe string DescribeProperty(string name)
        {
            fixed (byte* namePtr = Encoding.UTF8.GetBytes(name))
            {
                ...
                {
                    IntPtr res = SendMessage(scintilla, SciMsg.SCI_DESCRIBEPROPERTY, (IntPtr) namePtr, (IntPtr) descriptionPtr);
        ...
        public unsafe string DescribeKeyWordSets()
        {
            ...
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_DESCRIBEKEYWORDSETS, Unused, (IntPtr) descriptionsPtr);
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETLINEENDTYPESSUPPORTED, Unused, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_ALLOCATESUBSTYLES, styleBase, numberStyles);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSUBSTYLESSTART, styleBase, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSUBSTYLESLENGTH, styleBase, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSTYLEFROMSUBSTYLE, subStyle, Unused);
            return (int) res;
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETPRIMARYSTYLEFROMSTYLE, style, Unused);
            return (int) res;
        }
        ...
        {
            SendMessage(scintilla, SciMsg.SCI_FREESUBSTYLES, Unused, Unused);
        }
        ...
        public unsafe void SetIdentifiers(int style, string identifiers)
        {
            ...
            {
                SendMessage(scintilla, SciMsg.SCI_SETIDENTIFIERS, style, (IntPtr) identifiersPtr);
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_DISTANCETOSECONDARYSTYLES, Unused, Unused);
            return (int) res;
        }
        ...
        public unsafe string GetSubStyleBases()
        {
            ...
            fixed (byte* stylesPtr = stylesBuffer)
            {
                IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETSUBSTYLEBASES, Unused, (IntPtr) stylesPtr);
                return Encoding.UTF8.GetString(stylesBuffer).TrimEnd('\0');
            }
        }
        ...
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETUSEPALETTE, Unused, Unused);
            return 1 == (int) res;
        }
        ...
        {
            SendMessage(scintilla, SciMsg.SCI_SETUSEPALETTE, usePalette ? 1 : 0, Unused);
        }
        ...
        {
            SendMessage(scintilla, SciMsg.SCI_SETKEYSUNICODE, keysUnicode ? 1 : 0, Unused);
        }

        /// <summary>Are keys always interpreted as Unicode? (Scintilla feature 2522)</summary>
        public bool GetKeysUnicode()
        {
            IntPtr res = SendMessage(scintilla, SciMsg.SCI_GETKEYSUNICODE, Unused, Unused);
            return 1 == (int) res;
        }
